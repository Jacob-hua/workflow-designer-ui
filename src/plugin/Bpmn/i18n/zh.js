...
export default {
  ...
  [shapeType.TASK]: '任务',
  [shapeType.SEND_TASK]: '发送任务',
  [shapeType.RECEIVE_TASK]: '接收任务',
  [shapeType.USER_TASK]: '用户任务',
  [shapeType.MANUAL_TASK]: '手工任务',
  [shapeType.BUSINESS_RULE_TASK]: '业务规则任务',
  [shapeType.SERVICE_TASK]: '服务任务',
  [shapeType.SCRIPT_TASK]: '脚本任务',
  [shapeType.CALL_ACTIVITY]: '调用活动',
  ...
  [shapeType.TIMER_START_EVENT]: '定时开始事件',
  [shapeType.CONDITIONAL_START_EVENT]: '条件开始事件',
  [shapeType.SIGNAL_START_EVENT]: '信号开始事件',
  [shapeType.MESSAGE_INTERMEDIATE_CATCH_EVENT]: '消息中间捕获事件',
  [shapeType.MESSAGE_INTERMEDIATE_THROW_EVENT]: '消息中间抛出事件',
  [shapeType.TIMER_INTERMEDIATE_CATCH_EVENT]: '定时中间捕获事件',
  [shapeType.ESCALATION_INTERMEDIATE_THROW_EVENT]: '升级中间抛出事件',
  [shapeType.CONDITIONAL_INTERMEDIATE_CATCH_EVENT]: '条件中间捕获事件',
  [shapeType.LINK_INTERMEDIATE_CATCH_EVENT]: '链接中间捕获事件',
  [shapeType.LINK_INTERMEDIATE_THROW_EVENT]: '链接中间抛出事件',
  [shapeType.COMPENSATE_INTERMEDIATE_THROW_EVENT]: '补偿中间抛出事件',
  [shapeType.SIGNAL_INTERMEDIATE_CATCH_EVENT]: '信号中间捕获事件',
  [shapeType.SIGNAL_INTERMEDIATE_THROW_EVENT]: '信号中间抛出事件',
  ...
  [shapeType.TIMER_NON_INTERRUPTING_BOUNDARY_EVENT]: '定时边界事件（非中断）',
  ...
  [shapeType.END_EVENT]: '结束事件',
  [shapeType.MESSAGE_END_EVENT]: '消息结束事件',
  [shapeType.ESCALATION_END_EVENT]: '升级结束事件',
  [shapeType.ERROR_END_EVENT]: '错误结束事件',
  [shapeType.COMPENSATE_END_EVENT]: '补偿结束事件',
  [shapeType.SIGNAL_END_EVENT]: '信号结束事件',
  [shapeType.TERMINATE_END_EVENT]: '终止结束事件',
  [shapeType.EXCLUSIVE_GATEWAY]: '互斥网关',
  [shapeType.PARALLEL_GATEWAY]: '并行网关',
  [shapeType.INCLUSIVE_GATEWAY]: '相容网关',
  [shapeType.EVENT_BASE_GATEWAY]: '事件网关',
  [shapeType.COMPLEX_GATEWAY]: '复杂网关',
  [shapeType.SEQUENCE_FLOW]: '顺序流',
}

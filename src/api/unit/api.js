...
// 关联表单
export const associationForm = (params) =>
  post("/design/formDesignService/associationForm", params);
...
export const getExecuteDetail = (params) =>
  get("/execute/executeDetail", params);
...
// 流程图详情
export const postProcessResource = (params) =>
  post("/execute/processResource", params);
...
export const mappingGroup = (params) =>
  post("/permission/mapping/group", params);

...
export const processVariable = (params) =>
  get(`/execute/processVariable`, params);
...
export const getAllBusinessConfig = (params) =>
  get(`/config/businessConfig/getAllBusinessConfig`, params);
// 清除缓存的数据
...
export const checkCode = (params) =>
  get(`/config/businessConfig/checkBusinessConfigCode`, params);
...
export const getBusinessConfigWithTree = (id, tenantId) =>
  get(
    `/config/businessConfig/getBusinessConfigWithTree?tenantId=${tenantId}&id=${id}`
  );
// 删除配置
export const deleteBusinessConfig = (params) =>
  deletefn(`/config/businessConfig/delete`, params);
...
// 启动项删除
export const startConfigDelete = (params) =>
  deletefn("/config/startConfig/delete", params);
// 启动项修改/config/startConfig/update
export const startConfigUpdate = (params) =>
  put("/config/startConfig/update", params);

// 根据业务节点获取配置
export const checkIsReferenced = (params) =>
  get(`/config/startConfig/checkIsReferenced`, params);

export const startConfig = (params) =>
  post("/config/startConfig/create", params);
// 回去第三方杰奎
...
export const selectProcessStartConfigList = (id, tenantId) =>
  get(
    `/config/startConfig/selectProcessStartConfigList?tenantId=${tenantId}&businessConfigId=${id}`
  );

export const checkApiType = (params) =>
  post(`/config/global/checkApiType`, params);
export const checkSourceSort = (params) =>
  post(`config/global/checkSourceSort`, params);

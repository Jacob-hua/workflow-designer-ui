...
import customTranslate from "@/assets/js/customTranslate.js";
  ...
  methods: {
    ...
    async init() {
      ...
      this.bpmnModeler = new BpmnModeler({
        ...
        additionalModules: [propertiesProviderModule, propertiesPanelModule, { translate: ["value", customTranslate] }],
        moddleExtensions: {

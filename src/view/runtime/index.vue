<template>
  <div class="runtime">
    ...
    <runtime-add :dialogVisible="runtimeAddVisible" :projectCode="getData.projectCode" @close="closeDialogAdd"
      @succseeAdd="succseeAdd()"></runtime-add>
    <runTimeImplement :dialogVisible="runtimeImplementVisible" @close="closeDialogImplement" @goSee="detailsDiolog" ref="runTimeImplement"

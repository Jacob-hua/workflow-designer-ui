  ...
  <div class="runtime">
    <div class="runtime-filter">
      ...
      <div class="businessSelect marginRight20">
        <el-cascader v-model="getData.businessCode"
                     :key="getData.projectCode"
                     :options="rootOrganizationChildren(getData.projectCode)"
                     :props='cascaderProps'
                     @change="getAllApi()"></el-cascader>
      </div>
      <div class="datePick">
    ...
    <div class="runtime-table">
      <div class="home-table-main">
        <el-table :data="tableData"
          ...
          <el-table-column label="执行进程"
                           align="center"
                           min-width="250">
            <template slot-scope="scope">
              <el-steps :active="scope.row.trackList.length"
                        align-center
                        process-status="success">
                <el-step :title="item.taskName"
    ...
    <runTimeImplement :dialogVisible="runtimeImplementVisible"
                      ...
                      :business="getData.projectCode"></runTimeImplement>
    <lookover ref="lookover"
              @goReject="deployDiolog"></lookover>
  </div>
</template>
  ...
  methods: {
    ...
    deployDiolog(row) {
      ...
      this.$nextTick(() => {
        ...
        this.$refs.runTimeImplement.$refs.ProcessInformation.createNewDiagram(
          row.content,
          row.taskKey
        )
        this.$refs.runTimeImplement.$refs.ProcessInformation.postData = row
        this.$refs.runTimeImplement.$refs.ProcessInformation.postData.deployName =
          row.processName
        this.$refs.runTimeImplement.$refs.ProcessInformation.postData.version =
          row.starter
        this.$refs.runTimeImplement.$refs.ProcessInformation.postData.createTime =
          row.startTime
        this.$refs.runTimeImplement.$refs.ProcessInformation.postData.systemType =
          row.energyType
        this.$refs.runTimeImplement.dataList.Hang =
          row.taskStatus.split(',').indexOf('hang') == '-1'
    ...
    detailsDiolog(row) {
      ...
      this.$nextTick(() => {
        ...
        this.$refs.lookover.$refs.ProcessInformation.postData.deployName =
          row.processName
        this.$refs.lookover.$refs.ProcessInformation.postData.version =
          row.starter
        this.$refs.lookover.$refs.ProcessInformation.postData.createTime =
          row.startTime
        this.$refs.lookover.$refs.ProcessInformation.postData.systemType =
          row.energyType
        this.$refs.lookover.getListData(row.trackList)
        this.$refs.lookover.$refs.ProcessInformation.createNewDiagram(
          row.content,
          row.taskKey
        )
      })

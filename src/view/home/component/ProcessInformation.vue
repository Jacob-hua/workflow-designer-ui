  ...
  <div class="ProcessInformation">
    <div class="ProcessInformation-title">
      ...
      <div class="title-item">
        ...
        <div class="title-item-main">
          <el-input :value="$getMappingName(postData.ascription)" placeholder="" :disabled="true"></el-input>
        </div>
      </div>
      <div class="title-item">
        <span class="title-item-label"> 流程类型 </span>
        <div class="title-item-main">
          <el-input :value="$getMappingName(postData.business)" placeholder="" :disabled="true"></el-input>
        </div>
      </div>
      ...
      <div class="title-item" v-if="type !== 'details1'" v-show="postData.systemType !== postData.business">
        <span class="title-item-label marginLeft40"> 部署类型 </span>
        <div class="title-item-main">
    ...
    <div v-if="type == 'details2'">
      ...
      <span
        class="bnpmSwitch"
        v-if="seeType === 'delete'"
        v-role="{ id: 'HomeStart', type: 'button', business: business }"
      >
        <el-switch v-model="switchValue" active-color="#13ce66" active-text="激活"> </el-switch>
      </span>
    </div>
...
import { processInstanceData } from '@/api/unit/api.js'
export default {
  props: {
    type: String,
    seeType: {

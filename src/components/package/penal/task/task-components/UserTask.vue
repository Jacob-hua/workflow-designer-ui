  ...
  <div style="margin-top: 16px">
    <el-form-item label="处理用户" class="flexDis">
      <el-cascader v-model="value" :options="options" :props="{
        ...
        @change="handleChange" ref="elCascader">
      </el-cascader>
    ...
    <el-form-item label="到期时间">
      ...
      <el-date-picker v-model="userTaskForm.dueDate" type="datetime" @change="updateElementTask('dueDate')" placeholder="选择到期时间">
      </el-date-picker>
    </el-form-item>
    <el-form-item label="跟踪时间">
      <!-- <el-input v-model="userTaskForm.followUpDate" clearable @change="updateElementTask('followUpDate')" /> -->
      <el-date-picker v-model="userTaskForm.followUpDate" type="datetime" @change="updateElementTask('followUpDate')" placeholder="选择跟踪时间">
         </el-date-picker>
    </el-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      updateElementTask(key) {
        ...
        if (key === "candidateUsers" || key === "candidateGroups") {
          taskAttr[key] = this.userTaskForm[key] && this.userTaskForm[key].length ? this.userTaskForm[key].join() :
            null;
        } else {
